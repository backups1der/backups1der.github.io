+++
title = "Blog But Smaller"
description = """Blog but smaller (rightfully so). Lowkey abbreviates to BBS (Bulletin Board System).
I should probably be calling this a better name, like, IDK; nanolog or picoblog — I'ma use that later."""

sort_by = "date"
generate_feeds = true
template = "bbs.html"

extra.accent_color = "green"
extra.bbs.header = "# Entries"
+++
