...
- [ ] Implement 88x31's and add people's to my site

- [ ] `border-radius: 0;`-ify the site (**BAD BAD BAD IDEA**)
...
- [ ] Get a new domain name that's cheaper (and probably _sillier_)
...
### [RetroBloxxer](https://retrobloxxer.github.io/)
